...
export default function EditarObraPage() {
        ...
        <CardContent className="pt-6">
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            <p className="text-muted-foreground mt-2">
              Não foi possível encontrar os dados desta obra.
            </p>
            <Button
              variant="outline"
              className="mt-4"
  ...
  return (
    <ProtectedPage permissionKey="OBRAS">
      <div className="container mx-auto py-8 px-4">
        <Card className="border-0 shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-2xl font-bold">
              Editar Obra: {data.title}
            </CardTitle>
            <CardDescription>
              Atualize as informações de evolução da obra
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
            ...
            {success && (
              <Alert className="mb-6 bg-green-50 text-green-700 border-green-200">
                ...
                <AlertDescription>
                  Obras atualizadas. Você será redirecionado em instantes...
                </AlertDescription>
              </Alert>
            )}
                ...
                {[
                  ...
                  <div className="space-y-2" key={field}>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleChange(
                          field as keyof ProjectEvolution,
                          e.target.value
                        )
                      }
                    />
